...
public:
    ...
    struct SerializedChunk {
        ...
        uint32_t version = 2; // Version du format pour la compatibilité future
    };
...
private:
    ...
    // - chunkZ (int32_t)
    // - biome (uint8_t)
    // - voxelData: pour chaque voxel (16*128*16):
    ...
    static constexpr size_t CHUNK_DATA_SIZE = Chunk::SIZE * Chunk::HEIGHT * Chunk::SIZE * VOXEL_SIZE;
